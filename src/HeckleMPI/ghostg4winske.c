...
typedef struct GhostG4Winske_s
{
...
/*---------------------------------------------------------------------------
 ...
 ---------------------------------------------------------------------------*/
static void findGhostIndices(GhostG4Winske *self, const STX* const sx)
{
...
{
    int t;
    GhostG4Winske* self = malloc(sizeof *self);
        ...
        for (i = is0; i <= is1; i++)
        {
            for (j = js0; j <= js1; j++)
            {
                for (k = ks0; k <= ks1; k++)
                {
                    ...
                    self->sendbuff[t][cpt].pxx = s4[ijk].ps[0];
                    self->sendbuff[t][cpt].pxy = s4[ijk].ps[1];
                    self->sendbuff[t][cpt].pxz = s4[ijk].ps[2];
                    self->sendbuff[t][cpt].pyy = s4[ijk].ps[3];
                    self->sendbuff[t][cpt].pyz = s4[ijk].ps[4];
                    self->sendbuff[t][cpt].pzz = s4[ijk].ps[5];
            ...
            for (i = ir0; i <= ir1; i++)
            {
                for (j = jr0; j <= jr1; j++)
                {
                    for (k = kr0; k <= kr1; k++)
                    {
                        ...
                        s4[ijk].ps[0] = self->recvbuff[t][cpt].pxx;
                        s4[ijk].ps[1] = self->recvbuff[t][cpt].pxy;
                        s4[ijk].ps[2] = self->recvbuff[t][cpt].pxz;
                        s4[ijk].ps[3] = self->recvbuff[t][cpt].pyy;
                        s4[ijk].ps[4] = self->recvbuff[t][cpt].pyz;
                        s4[ijk].ps[5] = self->recvbuff[t][cpt].pzz;
